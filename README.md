...
>
> Programı ilk kez çalıştırırken Windows SmartScreen **"Windows kişisel bilgisayarınızı korudu"** şeklinde mavi bir uyarı verebilir.
>
> Bu durum, programın henüz yaygın bir dijital imzaya sahip olmamasından kaynaklanır ve **güvenli olmadığı anlamına gelmez**. Kuruluma devam etmek için:
> 1. **"Ek Bilgi"** yazısına tıklayın.
> 2. Açılan butondan **"Yine de Çalıştır"** diyerek devam edin.
